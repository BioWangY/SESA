...
large_ls = []
for i in os.listdir('./pred_results_final_sars2/'):
    with open('./pred_results_final_sars2/'+i) as file:
...
plt.text(0.7, 0.3, 'SPIKE', fontsize=20, color='black')

plt.savefig('Fig4b_sars2.png',dpi=200)
plt.show()
