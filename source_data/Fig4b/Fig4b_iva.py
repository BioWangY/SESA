# -*- coding: utf-8 -*-
"""
Created on Sun Feb 25 20:21:00 2024
...
large_ls = []
for i in os.listdir('./pred_results_final_iva/'):
    with open('./pred_results_final_iva/'+i) as file:
...
plt.text(0.7, 0.3, 'HA', fontsize=20, color='black')
plt.savefig('Fig4b_iva.png',dpi=200)
plt.show()