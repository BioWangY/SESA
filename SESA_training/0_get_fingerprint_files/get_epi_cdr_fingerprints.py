# -*- coding: utf-8 -*-
# this code is for getting fingerprint of epitope pdb file
...
if __name__ == "__main__":
    ...
    aaindexf = './usedAAindex.csv'
    
    epitope_pdb_path = './ag_pdb_imgt/'
    epitopeFingerFopath = './agAAindex.txt'
    
    for i in os.listdir(epitope_pdb_path):
        main(aaindexf,epitope_pdb_path+i,epitopeFingerFopath)
    
    cdr_pdb_path = './ab_cdr_pdb_imgt/'
    cdrFingerFopath = './cdrAAindex.txt'
    
    for j in os.listdir(cdr_pdb_path):
        main(aaindexf,cdr_pdb_path+j,cdrFingerFopath)